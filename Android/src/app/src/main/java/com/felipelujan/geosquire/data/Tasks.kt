...
package com.felipelujan.geosquire.data
...
enum class TaskType(val label: String, val id: String) {
  ...
  LLM_ASK_IMAGE(label = "Chat with Geo expert", id = "llm_ask_image"),
  LLM_ASK_HAND_SAMPLE(label = "Classify hand sample", id = "llm_ask_hand_sample"),
  LLM_ANALYZE_OUTCROP(label = "Analyze Outcrop", id = "llm_analyze_outcrop"),
  LLM_ASK_AUDIO(label = "Transcribe as Geo-pro", id = "llm_ask_audio"),
...
data class Task(
  ...
  /** Image resource for the task description. */
...
val TASK_LLM_CHAT =
  Task(
    ...
    description = "Load the Gemma3n as .task file.",
...
val TASK_LLM_ASK_IMAGE =
  Task(
    ...
    icon = Icons.Outlined.Forum,
    models = mutableListOf(),
    description = "Chat with an with an Offline AI about think minerals, rock types, geogenesis, eras, and more. " +
...
val TASK_LLM_ASK_HAND_SAMPLE =
  Task(
    ...
    imageResourceId = R.drawable.hand_sample,
    docUrl = "https://ai.google.dev/edge/mediapipe/solutions/genai/llm_inference/android",
    sourceCodeUrl = "",
    textInputPlaceHolderRes = R.string.text_input_placeholder_llm_chat,
  )

val TASK_LLM_ANALYZE_OUTCROP =
  Task(
    ...
    imageResourceId = R.drawable.outcrop,
    docUrl = "https://ai.google.dev/edge/mediapipe/solutions/genai/llm_inference/android",
    sourceCodeUrl = "",
    textInputPlaceHolderRes = R.string.text_input_placeholder_llm_chat,
  )
...
/** All tasks. */
val TASKS: List<Task> =
  listOf(TASK_LLM_ASK_IMAGE, TASK_LLM_ASK_HAND_SAMPLE, TASK_LLM_ANALYZE_OUTCROP)
