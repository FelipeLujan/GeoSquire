...
object LlmAskHandSampleDestination {
  val route = "LlmAskHandSampleRoute"
}

object LlmAnalyzeOutcropDestination {
  val route = "LlmAnalyzeOutcropRoute"
}
...
@Composable
fun LlmAskHandSampleScreen(
  modelManagerViewModel: ModelManagerViewModel,
  navigateUp: () -> Unit,
  modifier: Modifier = Modifier,
  viewModel: LlmAskHandSampleViewModel,
) {
  ChatViewWrapper(
    viewModel = viewModel,
    modelManagerViewModel = modelManagerViewModel,
...
@Composable
fun LlmAnalyzeOutcropScreen(
  modelManagerViewModel: ModelManagerViewModel,
  navigateUp: () -> Unit,
  modifier: Modifier = Modifier,
  viewModel: LlmAnalyzeOutcropViewModel,
) {
  ChatViewWrapper(
    viewModel = viewModel,
    modelManagerViewModel = modelManagerViewModel,
